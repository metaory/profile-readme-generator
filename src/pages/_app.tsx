...
const App = ({ Component, pageProps }: AppProps) => {
  ...
  useEffect(() => {
    ...
    return () => {
      events.off('contextmenu', handlePreventRightClick);
    };
  }, []);
  ...
  return (
    <ThemeProvider theme={theme}>
        ...
        <meta name="google-site-verification" content="nH_oO8Fxc76PZpqDg9y4loKj8DNPDL84Zz0zAKgAaSA" />
        <meta name="author" content="Mauro de Souza" />
        <meta name="robots" content="index,nofollow" />
        <meta name="theme-color" content="#58a6ff" />
        <meta name="description" content={description} />
        <meta name="keywords" content="github, github profile, github profile readme, readme generator, profile readme generator, github profile readme generator" />
        ...
        <meta name="twitter:creator" content="https://github.com/maurodesouza" />
      </Head>
      <ExtensionsProvider>
        <CanvasProvider>
          <SettingsProvider>
